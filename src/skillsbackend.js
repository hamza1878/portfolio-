...
const skills = {
    "Back-End": [
        { name: "Apollo GraphQL", icon: "🔙"  ,level: "Pro"},
        { name: "SQL", icon: "📤" ,level: "Pro" },
        { name: "Node.js", icon: "🌐" ,level: "Avancé" },
        { name: "Express.js", icon: "👨‍💻",level: "Avancé" },
        { name: "Python", icon: "🐍" ,level: "Avancé" },
        { name: "Flask", icon: "⚙️" ,level: "Avancé" },
...
const levels = ["Pro", "Avancé", "Intermédiaire", "Débutant"];
